...
foreach ($seed in @(11, 22, 33, 44, 55)) {
  $generation = "experiments/results/codec_tts_unique_before/seed_$seed"
...
Invoke-CheckedPython scripts/summarize_codec_tts.py `
  --results-dir experiments/results/codec_tts_unique_before `
  --training-dir checkpoints/codec_tts `
  --output experiments/results/codec_tts_unique_before/summary.json `
  --markdown-output experiments/results/codec_tts_unique_before/summary.md
